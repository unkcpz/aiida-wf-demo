#
# Sphinx configuration for aiida-wf-demo
#
...
release = aiida_wf_demo.__version__
...
html_title = f"aiida-wf-demo v{release}"
html_theme_options = {}
...
html_use_opensearch = "https://aiida-wf-demo.readthedocs.io"
...
def run_apidoc(_):
    ...
    package_dir = os.path.join(source_dir, os.pardir, os.pardir, "aiida_wf_demo")
